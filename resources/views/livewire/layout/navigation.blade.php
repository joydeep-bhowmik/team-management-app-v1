        ...
        <div class="flex h-16 justify-between">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @foreach (NavController::admin_pages() as $page)
                        @php
                            $page = (object) $page;
                        @endphp
                        <x-nav-link :href="route($page->route)" :active="request()->routeIs($page->route)" wire:navigate>
                            {{ __($page->label) }}
                        </x-nav-link>
                    @endforeach
        ...
        <div class="space-y-1 pb-3 pt-2">
            ...
            @foreach (NavController::admin_pages() as $page)
                @php
                    $page = (object) $page;
                @endphp
                <x-responsive-nav-link :href="route($page->route)" :active="request()->routeIs($page->route)" wire:navigate>
                    {{ __($page->label) }}
